...
$(document).ready(function(){
  ...
  // Un exemple de script pour faire changer la =  couleur de fond du site
 ...
 if(quantity >= 10)
{
    alert("Vous avez droit à un rabais de 10%.");
    discount = subTotal * 0.1;
}

else
{
   alert("Il vous manque " + (10 - quantity) + " articles pour avoir droit à un rabais de 10%."); 
}
    
var taxes = (subTotal - discount) * 0.15;
...
$("input[name='color']").change(function(){
  ...
  $("#prodColor").change(function(){
    var color = $(this).val();
    $("#tshirt-image").attr("src", "img/t-shirt-" + color + ".jpg");
  });
  ...
  $( "#calculate" ).click(function() {
    ...
    //Calcul des taxes
    var taxes = (subTotal - discount) * (0.05 + 0.09975);
    $("#taxes").html(taxes.toFixed(2) + " $");

    //Ajout du shipping
    /*var shipping = 0;
    if($('#shippingType').is(':checked')){
      shipping = 5.25;
    }
    $("#shipping").html(shipping.toFixed(2) + " $"*/;

    //Calcul du total
    var total = subTotal - discount + taxes; //+ shipping ;
    $("#total").html(total.toFixed(2) + " $");
  });
